...
def generate_answers():
    ...
    print "Question 3:"
    ans_Q3 = select_array_elements_answer.select_elements()
    print ans_Q3

    #Question 4
    print "Question 4:"
    print "Please wait for the picture to be generated..."
    N = 500 # decide the resolution of the mask
...
if __name__ == "__main__":
    try:
        ...
        print "the program has been interrupted by ZeroDivisionError, thanks for trying, Goodbye"
